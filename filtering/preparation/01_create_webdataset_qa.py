...
def main():
    ...
    parser.add_argument('--jsonl_path', type=str, default='./output/final_combined_outputs_filtered_0.50_3.0time_with_Qwen2.5_creative_qa_simple_True.jsonl',
    ...
    parser.add_argument('--output_dir', type=str, default='./training_qwen2.5_creative_qa_simple',
